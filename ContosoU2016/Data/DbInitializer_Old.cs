...
namespace ContosoU2016.Models
{
    ...
    public static class DbInitializer_Old
    {
        public static void Initialize(SchoolContext context)
        {
            ...
            {
                new Instructor{FirstName="Leanne",LastName="Williston", Email="leanne.williston@staff.contoso.com",HireDate=DateTime.Parse("1997-05-01")},
                new Instructor{FirstName="John",LastName="Smith", Email="jsmith@staff.contoso.com",HireDate=DateTime.Parse("1995-09-01")}
            };
